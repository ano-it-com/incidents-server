...
final class Version20201222145255 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE eav_entity (id UUID NOT NULL, type_id UUID NOT NULL, external_id INT DEFAULT NULL, meta JSONB DEFAULT NULL, PRIMARY KEY(id))');
