...
namespace ANOITCOM\EAVBundle\Tests\Functional\TypePropertyRelationType;
...
class TypePropertyRelationTypeTest extends BundleWithPostgresTestCase
{
    ...
    private function getFromDbById(string $id): ?EAVTypePropertyRelationType
    {
        /** @var EAVTypePropertyRelationType[] $typesFromDb */
        $typesFromDb = $this->relationTypeRepository->findBy([ (new TypePropertyRelationTypeFilterCriteria())->where('id', '=', $id) ]);

        return count($typesFromDb) ? $typesFromDb[0] : null;
    }


    private function compareTwoTypes(EAVTypePropertyRelationType $type1, EAVTypePropertyRelationType $type2): void
    {
        ...
        $restrictionsFromDb = array_combine(array_map(function (EAVTypePropertyRelationTypeRestriction $restriction) { return $restriction->getId(); }, $restrictionsFromDb), $restrictionsFromDb);

        self::assertSameSize($type1->getRestrictions(), $restrictionsFromDb);

        /**
         * @var string                                 $id
         * @var EAVTypePropertyRelationTypeRestriction $restriction
         */
    ...
    public function testAddDeleteChangeRestrictions(): void
    {
        ...
        // new
        $newRestriction = new EAVTypePropertyRelationTypeRestriction(Uuid::uuid4()->toString());
        ...
        //updated
        /** @var EAVTypePropertyRelationTypeRestriction $propToChange */
    ...
    protected function setUp(): void
    {
        ...
        $this->relationTypeRepository = self::$container->get(EAVTypePropertyRelationTypeRepository::class);
