...
class TypePropertyRelationFilterColumn implements ColumnInterface
{
    ...
    {
        return $eavSettings->getTableNameForEntityType(EAVSettings::TYPE_PROPERTY_RELATION) . '.' . $this->columnName;
