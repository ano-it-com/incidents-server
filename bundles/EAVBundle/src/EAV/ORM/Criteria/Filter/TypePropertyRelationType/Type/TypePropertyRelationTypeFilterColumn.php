...
class TypePropertyRelationTypeFilterColumn implements ColumnInterface
{
    ...
    {
        return $eavSettings->getTableNameForEntityType(EAVSettings::TYPE_PROPERTY_RELATION_TYPE) . '.' . $this->columnName;
